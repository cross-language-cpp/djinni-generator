/** Copyright 2015 Dropbox, Inc. Copyright 2021 cross-language-cpp
  *
  ...
  def writeCffiFile(ident: String, origin: String, f: IndentWriter => Unit) {
    createFileOnce(
      ...
      (w: IndentWriter) => {
        ...
        w.wl("# This file was generated by Djinni from " + spec.idlFileName)
        w.wl
        f(w)
      }
    )
  ...
  override def generateInterface(
    ...
    writeCffiFile(
      ...
      w => {
        ...
        w.wl
        w.wl(
          "ffi.set_source('" + cffi + "', '''#include \"clean_headers.h\"''',"
        ).nested {

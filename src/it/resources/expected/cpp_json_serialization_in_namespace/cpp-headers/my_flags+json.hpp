...
struct adl_serializer<::custom_namespace::MyFlags>
{
    ...
    {
        static const std::pair<::custom_namespace::MyFlags, json> m[] = {{::custom_namespace::MyFlags::FLAG1,"flag1"},{::custom_namespace::MyFlags::FLAG2,"flag2"},{::custom_namespace::MyFlags::FLAG3,"flag3"}};
        j = json::array();

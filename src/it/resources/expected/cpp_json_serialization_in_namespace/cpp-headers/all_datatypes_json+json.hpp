...
template <>
struct adl_serializer<::custom_namespace::AllDatatypesJson>  {
    static ::custom_namespace::AllDatatypesJson from_json(const json & j)  {
        auto result = ::custom_namespace::AllDatatypesJson();
    ...
    static void to_json(json & j, const ::custom_namespace::AllDatatypesJson & item)  {
        j = json {

...
void my_record_add_callback_python_create_my_record(struct DjinniRecordHandle *( * ptr)(int32_t, struct DjinniString *, struct DjinniObjectHandle *, struct DjinniObjectHandle *));
